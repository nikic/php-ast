...
const USE_CONST = 4;
const MAGIC_LINE = 378;
const MAGIC_FILE = 379;
const MAGIC_DIR = 380;
const MAGIC_NAMESPACE = 385;
const MAGIC_FUNCTION = 384;
const MAGIC_METHOD = 383;
const MAGIC_CLASS = 381;
const MAGIC_TRAIT = 382;
