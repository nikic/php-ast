...
const AST_FUNC_DECL = 68;
const AST_CLOSURE = 69;
const AST_METHOD = 70;
const AST_ARROW_FUNC = 72;
const AST_CLASS = 71;
const AST_PROPERTY_HOOK = 73;
...
const AST_EMPTY = 263;
const AST_ISSET = 264;
const AST_SHELL_EXEC = 266;
const AST_CLONE = 508;
const AST_EXIT = 509;
const AST_PRINT = 267;
const AST_INCLUDE_OR_EVAL = 268;
const AST_UNARY_OP = 269;
const AST_PRE_INC = 270;
const AST_PRE_DEC = 271;
const AST_POST_INC = 272;
const AST_POST_DEC = 273;
const AST_YIELD_FROM = 274;
...
const AST_CLASS_NAME = 275;
const AST_PROPERTY_HOOK_SHORT_BODY = 287;
const AST_CLASS_CONST_GROUP = 776;
const AST_DIM = 512;
const AST_PROP = 513;
...
const USE_CONST = 4;
const MAGIC_LINE = 346;
const MAGIC_FILE = 347;
const MAGIC_DIR = 348;
const MAGIC_NAMESPACE = 354;
const MAGIC_FUNCTION = 352;
const MAGIC_METHOD = 351;
const MAGIC_CLASS = 349;
const MAGIC_TRAIT = 350;
