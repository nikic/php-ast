...
const size_t ast_kinds_count = 95;
...
const char *ast_kind_to_name(zend_ast_kind kind) {
	switch (kind) {
		...
		case ZEND_AST_RESOLVE_CLASS_NAME: return "AST_RESOLVE_CLASS_NAME";
...
void ast_register_kind_constants(INIT_FUNC_ARGS) {
	...
	REGISTER_NS_LONG_CONSTANT("ast", "AST_RESOLVE_CLASS_NAME", ZEND_AST_RESOLVE_CLASS_NAME, CONST_CS | CONST_PERSISTENT);
